...
[FundAGoal](https://github.com/codeBigInt/fundagoal), the winning project of the [African Blockchain Championship](https://www.africanblockchamp.com/), is a decentralized funding platform built on the Midnight network.   
It enables creators to propose project ideas, secure funding, and protect the identities of both campaign creators and backers. By prioritizing privacy and transparency, [FundAGoal](https://github.com/codeBigInt/fundagoal) fosters trust in crowdfunding while empowering communities to support innovative initiatives.   
...
<!-- - **[BetaEdu](https://github.com/Akeem1955/BetaEdu)** — Private education record system for African universities   -->

<!-- - **[SmartWaste](https://github.com/AbdulA3eem/Smart-waste-NG.git)** — Waste tokenization + ZK reward contracts   -->

<!-- - **[Tetragric](https://github.com/elconrad23/tetragric.git)** — ZK marketplace for agricultural assets   -->

<!-- - **[MIDREM](https://github.com/ndigirigijohn/MIDREM.git)** — Health record registry with zero-knowledge protection   -->

<!-- - **[CrisisChain](https://github.com/Dibora12/CrisisChain-Blockchain-Powered-Aid-Distribution-for-Africa)** — ZK supply chain tracking for aid logistics   -->

<!-- - **[Privote](https://github.com/kaleababayneh/zkvote-midnight)** — ZK voting app allowing anonymous ballot casting   -->

<!-- - **[Hello World](https://github.com/CylinderAdmin/midnight-starter)** — Minimal starter repo for new Midnight developers   -->

<!-- - **[🔹 midnight-identity-token](https://github.com/ErickRomeroDev/midnight-identity-token)** — Edda Labs’ smart token with ZK proof-of-identity mechanics   -->

<!-- - **[🔹 naval-battle-game](https://github.com/ErickRomeroDev/naval-battle-game_v2)** — Seabattle-style game using Midnight circuits  -->
