...
- [Nightwatch](https://github.com/Kshot3000/Cardano-Midnight-Qwen-Builder/tree/main/apps/nightwatch) - Privacy-network health dashboard for Midnight mainnet tracking transaction activity and growth, DUST consumption, and a transparent network health score from the NightForge explorer API - [Live site](https://kshot3000.github.io/Cardano-Midnight-Qwen-Builder/apps/nightwatch/)
...
- [Privoice](https://github.com/tomiin/privoice) - Invoice registry on Midnight that stores a commitment on-chain and records issue, acknowledgement, and settlement without putting amount or counterparty on the ledger.
...
- [Quote of the Day](https://github.com/oluwatobiss/quote-otd) - Prove your authorization to publish without revealing your private creator identity.
...
- [MatkaNight](https://github.com/hsay123/MatkaNight_) - Card prediction game on Midnight with Compact circuits for bet commit-and-settle and a React frontend. - [Demo](https://matkanight.vercel.app/)
...
- [Midnight Private Voting](https://github.com/Ansh-Sonkusare/zk-ballot) - Privacy-preserving ratings poll where voters commit hidden hashes of their vote, with tally reveal via ZK proofs using witnesses, commitments, and DApp-scoped keys. - [Demo](https://midnight-khaki.vercel.app)
